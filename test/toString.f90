program test_toString
    ...
    if (str == "-000000000000000000000000000000000000001") then
        print *, "PASSED: to_string for negative int8"
    else
        print *, "FAILED: to_string for negative int8. expected -000000000000000000000000000000000000001 but got"//str
    end if
    ...
    if (str == "-000000000000000000000000000000000000001") then
        print *, "PASSED: to_string for negative int16"
    else
        print *, "FAILED: to_string for negative int16. expected -000000000000000000000000000000000000001 but got"//str
    end if
    ...
    if (str == "-000000000000000000000000000000000000001") then
        print *, "PASSED: to_string for negative int32."
    else
        print *, "FAILED: to_string for negative int32. expected -000000000000000000000000000000000000001 but got"//str
    end if
    ...
    if (str == "-000000000000000000000000000000000000001") then
        print *, "PASSED: to_string for negative int64."
    else
        print *, "FAILED: to_string for negative int64. expected -000000000000000000000000000000000000001 but got"//str
    end if
    ...
    if (str == "-1") then
        print *, "PASSED: to_string for negative int8 with remove 0 padding"
    else
        print *, "FAILED: to_string for negative int8 with remove 0 padding. expected -1 but got"//str
    end if
    ...
    if (str == "-1") then
        print *, "PASSED: to_string for negative int16 with remove 0 padding"
    else
        print *, "FAILED: to_string for negative int16 with remove 0 padding. expected -1 but got"//str
    end if
    ...
    if (str == "-1") then
        print *, "PASSED: to_string for negative int32 with remove 0 padding"
    else
        print *, "FAILED: to_string for negative int32 with remove 0 padding. expected -1 but got"//str
    end if
    ...
    if (str == "-1") then
        print *, "PASSED: to_string for negative int64 with remove 0 padding"
    else
        print *, "FAILED: to_string for negative int64 with remove 0 padding. expected -1 but got"//str
    end if

    !--- as unsigned
    str = to_string(int(B"11111111", kind=int8), as_unsigned=.true.)
    if (str == "+000000000000000000000000000000000000255") then
        print *, "PASSED: to_string for unsigned int8"
    else
        print *, "FAILED: to_string for unsigned int8. "// &
    ...
    if (str == "+000000000000000000000000000000000065535") then
        print *, "PASSED: to_string for unsigned int16"
    else
        print *, "FAILED: to_string for unsigned int16. expected +000000000000000000000000000000000065535 but got"//str
    end if
    ...
    if (str == "+000000000000000000000000000004294967295") then
        print *, "PASSED: to_string for unsigned int32"
    else
        print *, "FAILED: to_string for unsigned int32. expected +000000000000000000000000000004294967295 but got"//str
    end if
    ...
    if (str == "+000000000000000000018446744073709551615") then
        print *, "PASSED: to_string for unsigned int64"
    else
        print *, "FAILED: to_string for unsigned int64. expected +000000000000000000018446744073709551615 but got"//str
    end if

    !--- remove 0 padding and as unsigned
    str = to_string(int(B"11111111", kind=int8), remove_0_padding=.true., as_unsigned=.true.)
    if (str == "255") then
        print *, "PASSED: to_string for unsigned int8 with remove 0 padding"
    else
        print *, "FAILED: to_string for unsigned int8 with remove 0 padding. "// &
            "expected 255 but got"//str
    end if

    str = to_string(int(B"1111111111111111", kind=int16), remove_0_padding=.true., as_unsigned=.true.)
    if (str == "65535") then
        print *, "PASSED: to_string for unsigned int16 with remove 0 padding"
    else
        print *, "FAILED: to_string for unsigned int16 with remove 0 padding. expected 65535 but got"//str
    end if
    ...
    if (str == "4294967295") then
        print *, "PASSED: to_string for unsigned int32 with remove 0 padding"
    else
        print *, "FAILED: to_string for unsigned int32 with remove 0 padding. expected 4294967295 but got"//str
    end if

    str = to_string(int(B"1111111111111111111111111111111111111111111111111111111111111111", kind=int64), &
                    remove_0_padding=.true., as_unsigned=.true.)
    if (str == "18446744073709551615") then
        print *, "PASSED: to_string for unsigned int64 with remove 0 padding"
    else
        print *, "FAILED: to_string for unsigned int64 with remove 0 padding. expected 18446744073709551615 but got"//str
    end if
